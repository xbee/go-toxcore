...
const (
	CONNECTION_NONE = uint32(C.TOX_CONNECTION_NONE)
	CONNECTION_TCP  = uint32(C.TOX_CONNECTION_TCP)
	CONNECTION_UDP  = uint32(C.TOX_CONNECTION_UDP)
)
...
const (
	GROUPCHAT_TYPE_TEXT = uint8(C.TOX_GROUPCHAT_TYPE_TEXT)
	GROUPCHAT_TYPE_AV   = uint8(C.TOX_GROUPCHAT_TYPE_AV)
)
